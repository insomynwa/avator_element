...
class Updater {
	...
	public function __construct() {
		$this->plugin_version = AVATOR_ELEMENT_VERSION;
		$this->plugin_name = AVATOR_ELEMENT_PLUGIN_BASE;
	...
	public function plugins_api_filter( $_data, $_action = '', $_args = null ) {
		...
		$cache_key = 'avator_element_api_request_' . substr( md5( serialize( $this->plugin_slug ) ), 0, 15 );
		...
		if ( empty( $api_request_transient ) ) {
			...
			$api_request_transient->name = 'Avator Element';
