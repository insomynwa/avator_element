...
class Fonts_Manager {
	...
	public function register_post_type_and_tax() {
		$labels = [
			'name' => _x( 'Custom Fonts', 'Elementor Font', 'avator-element' ),
			'singular_name' => _x( 'Font', 'Elementor Font', 'avator-element' ),
			'add_new' => _x( 'Add New', 'Elementor Font', 'avator-element' ),
			'add_new_item' => _x( 'Add New Font', 'Elementor Font', 'avator-element' ),
			'edit_item' => _x( 'Edit Font', 'Elementor Font', 'avator-element' ),
			'new_item' => _x( 'New Font', 'Elementor Font', 'avator-element' ),
			'all_items' => _x( 'All Fonts', 'Elementor Font', 'avator-element' ),
			'view_item' => _x( 'View Font', 'Elementor Font', 'avator-element' ),
			'search_items' => _x( 'Search Font', 'Elementor Font', 'avator-element' ),
			'not_found' => _x( 'No Fonts found', 'Elementor Font', 'avator-element' ),
			'not_found_in_trash' => _x( 'No Font found in Trash', 'Elementor Font', 'avator-element' ),
			'parent_item_colon' => '',
			'menu_name' => _x( 'Custom Fonts', 'Elementor Font', 'avator-element' ),
		];
		...
		$taxonomy_labels = [
			'name' => _x( 'Font Types', 'Font type taxonomy general name', 'avator-element' ),
			'singular_name' => _x( 'Font Type', 'Font type singular name', 'avator-element' ),
			'search_items' => __( 'Search Font Types', 'avator-element' ),
			'popular_items' => __( 'Popular Font Types', 'avator-element' ),
			'all_items' => __( 'All Font Types', 'avator-element' ),
			'edit_item' => __( 'Edit Font Type', 'avator-element' ),
			'update_item' => __( 'Update Font Type', 'avator-element' ),
			'add_new_item' => __( 'Add New Font Type', 'avator-element' ),
			'new_item_name' => __( 'New Font Type Name', 'avator-element' ),
			'separate_items_with_commas' => __( 'Separate Font Types with commas', 'avator-element' ),
			'add_or_remove_items' => __( 'Add or remove Font Types', 'avator-element' ),
			'choose_from_most_used' => __( 'Choose from the most used Font Types', 'avator-element' ),
			'not_found' => __( 'No Font Types found.', 'avator-element' ),
			'menu_name' => __( 'Font Types', 'avator-element' ),
		];
	...
	public function post_updated_messages( $messages ) {
		$messages[ self::CPT ] = [
			...
			1 => __( 'Font updated.', 'avator-element' ),
			2 => __( 'Custom field updated.', 'avator-element' ),
			3 => __( 'Custom field deleted.', 'avator-element' ),
			4 => __( 'Font updated.', 'avator-element' ),
			/* translators: %s: date and time of the revision */
			5 => isset( $_GET['revision'] ) ? sprintf( __( 'Font restored to revision from %s', 'avator-element' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6 => __( 'Font saved.', 'avator-element' ),
			7 => __( 'Font saved.', 'avator-element' ),
			8 => __( 'Font submitted.', 'avator-element' ),
			9 => __( 'Font updated.', 'avator-element' ),
			10 => __( 'Font draft updated.', 'avator-element' ),
		];
	...
	public function register_admin_menu() {
		$menu_title = _x( 'Custom Fonts', 'Elementor Font', 'avator-element' );
		add_submenu_page(
			Settings::PAGE_ID,
			$menu_title,
			$menu_title,
	...
	public function update_enter_title_here( $title, $post ) {
		if ( isset( $post->post_type ) && self::CPT === $post->post_type ) {
			return __( 'Enter Font Family', 'avator-element' );
		}
	...
	public function manage_columns( $columns ) {
		return [
			...
			'title' => __( 'Font Family', 'avator-element' ),
			'font_preview' => __( 'Preview', 'avator-element' ),
		];
	}
	...
	public function add_finder_item( array $categories ) {
		$categories['settings']['items']['custom-fonts'] = [
			'title' => __( 'Custom Fonts', 'avator-element' ),
			'icon' => 'typography',
	...
	protected function actions() {
		 ...
		 */
		do_action( 'avator_element/fonts_manager_loaded', $this );
	}
