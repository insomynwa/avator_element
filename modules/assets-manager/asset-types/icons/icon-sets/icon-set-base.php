<?php
namespace AvatorElement\Modules\AssetsManager\AssetTypes\Icons\IconSets;

use AvatorElement\Classes\Utils;
use AvatorElement\Modules\AssetsManager\AssetTypes\Icons\Custom_Icons;
...
abstract class Icon_Set_Base {
	...
	protected function get_file_url( $file_name ) {
		 ...
		 */
		$url = apply_filters( 'avator_element/icons_manager/custom_icons/url', $url, $file_name );
	...
	protected function get_icon_sets_dir() {
		 ...
		 * @param string $path .
		 */
		$path = apply_filters( 'avator_element/icons_manager/custom_icons/dir', $path );
