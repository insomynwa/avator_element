<?php
namespace AvatorElement\Modules\AssetsManager\AssetTypes\Icons;

use AvatorElement\Modules\AssetsManager\Classes\Assets_Base;
use AvatorElement\Modules\AssetsManager\AssetTypes\Icons_Manager;
...
class Font_Awesome_Pro extends  Assets_Base {
	...
	public function get_name() {
		return __( 'Font Awesome Pro', 'avator-element' );
	}
	...
	public function replace_font_awesome_pro( $settings ) {
		$json_url = AVATOR_ELEMENT_ASSETS_URL . 'lib/font-awesome-pro/%s.js';
		$icons['fa-regular'] = [
			'name' => 'fa-regular',
			'label' => __( 'Font Awesome - Regular Pro', 'avator-element' ),
			'url' => false,
			'enqueue' => false,
			'prefix' => 'fa-',
			'displayPrefix' => 'far',
		...
		$icons['fa-solid'] = [
			'name' => 'fa-solid',
			'label' => __( 'Font Awesome - Solid Pro', 'avator-element' ),
			'url' => false,
			'enqueue' => false,
			'prefix' => 'fa-',
			'displayPrefix' => 'fas',
		...
		$icons['fa-brands'] = [
			'name' => 'fa-brands',
			'label' => __( 'Font Awesome - Brands Pro', 'avator-element' ),
			'url' => false,
			'enqueue' => false,
			'prefix' => 'fa-',
			'displayPrefix' => 'fab',
		...
		$icons['fa-light'] = [
			'name' => 'fa-light',
			'label' => __( 'Font Awesome - Light Pro', 'avator-element' ),
			'url' => false,
			'enqueue' => false,
			'prefix' => 'fa-',
			'displayPrefix' => 'fal',
	...
	public function register_admin_fields( Settings $settings ) {
		$settings->add_section( Settings::TAB_INTEGRATIONS, 'font_awesome_pro', [
			'callback' => function() {
				echo '<hr><h2>' . esc_html__( 'Font Awesome Pro', 'avator-element' ) . '</h2>';
				esc_html_e( 'Font Awesome, the web\'s most popular icon set and toolkit, Pro Integration', 'avator-element' );
			},
			'fields' => [
				self::FA_KIT_ID_OPTION_NAME => [
					'label' => __( 'Kit ID', 'avator-element' ),
					'field_args' => [
						'type' => 'text',
						'desc' => sprintf( __( 'Enter Your <a href="%s" target="_blank">Font Awesome Pro Kit ID</a>.', 'avator-element' ), 'https://fontawesome.com/kits' ),
					],
					'setting_args' => [
				...
				'validate_api_data' => [
					'field_args' => [
						'type' => 'raw_html',
						'html' => sprintf( '<button data-action="%s" data-nonce="%s" class="button elementor-button-spinner" id="avator_element_fa_pro_validate_button">%s</button><br><p><span class="avator-element-fa_pro_data hidden"></span></p>',
							self::FA_KIT_ID_OPTION_NAME . '_fetch',
							wp_create_nonce( self::FA_KIT_ID_OPTION_NAME ),
							__( 'Validate Kit ID', 'avator-element' )
						),
					],
				],
			],
	...
	public function enqueue_kit_js() {
		wp_enqueue_script( 'font-awesome-pro', sprintf( self::FA_KIT_SCRIPT_LINK, $this->get_kit_id() ), [], AVATOR_ELEMENT_VERSION );
	}
