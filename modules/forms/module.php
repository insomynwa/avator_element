<?php
namespace AvatorElement\Modules\Forms;

use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use AvatorElement\Base\Module_Base;
use AvatorElement\Modules\Forms\Actions;
use AvatorElement\Modules\Forms\Classes;
use AvatorElement\Modules\Forms\Fields;
...
class Module extends Module_Base {
	/**
	 * @var \AvatorElement\Modules\Forms\Classes\Action_Base[]
	 */
	private $form_actions = [];
	/**
	 * @var \AvatorElement\Modules\Forms\Fields\Field_Base[]
	 */
	public $field_types = [];
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'x_field' => __( '%s Field', 'avator-element' ),
			],
		] );
	...
	public function forms_panel_action_data( array $data ) {
		...
		/** @var \AvatorElement\Modules\Forms\Classes\Integration_Base $integration */
	...
	public function __construct() {
		...
		if ( Classes\Ajax_Handler::is_form_submitted() ) {
			 ...
			 */
			do_action( 'avator_element/forms/form_submitted', $this );
		}
	}
}
