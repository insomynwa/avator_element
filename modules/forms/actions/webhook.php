...
class Webhook extends Action_Base {
	...
	public function get_label() {
		return __( 'Webhook', 'avator-element' );
	}
	...
	public function register_settings_section( $widget ) {
		$widget->start_controls_section(
			'section_webhook',
			[
				'label' => __( 'Webhook', 'avator-element' ),
				'condition' => [
		...
		$widget->add_control(
			...
			[
				...
				'placeholder' => __( 'https://your-webhook-url.com', 'avator-element' ),
				'label_block' => true,
				'separator' => 'before',
				'description' => __( 'Enter the integration URL (like Zapier) that will receive the form\'s submitted data.', 'avator-element' ),
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Advanced Data', 'avator-element' ),
	...
	public function run( $record, $ajax_handler ) {
		 ...
		 */
		$args = apply_filters( 'avator_element/forms/webhooks/request_args', $args, $record );
		 ...
		 * @param Form_Record     $record   An instance of the form record.
		 */
		do_action( 'avator_element/forms/webhooks/response', $response, $record );
