...
class Email extends Action_Base {
	...
	public function get_label() {
		return __( 'Email', 'avator-element' );
	}
	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
			...
			[
				'label' => __( 'To', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => get_option( 'admin_email' ),
				'placeholder' => get_option( 'admin_email' ),
				'label_block' => true,
				'title' => __( 'Separate emails with commas', 'avator-element' ),
				'render_type' => 'none',
			]
		);

		/* translators: %s: Site title. */
		$default_message = sprintf( __( 'New message from "%s"', 'avator-element' ), get_option( 'blogname' ) );

		$widget->add_control(
			$this->get_control_id( 'email_subject' ),
			[
				'label' => __( 'Subject', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				...
				'description' => sprintf( __( 'By default, all form fields are sent via %s shortcode. To customize sent fields, copy the shortcode that appears inside each field and paste it above.', 'avator-element' ), '<code>[all-fields]</code>' ),
				'label_block' => true,
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'From Email', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				'label' => __( 'From Name', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Reply-To', 'avator-element' ),
		...
		$widget->add_control(
			...
			[
				...
				'options' => [
					...
					'page_url' => __( 'Page URL', 'avator-element' ),
					'user_agent' => __( 'User Agent', 'avator-element' ),
					'remote_ip' => __( 'Remote IP', 'avator-element' ),
					'credit' => __( 'Credit', 'avator-element' ),
				],
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Send As', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'html',
				'render_type' => 'none',
				'options' => [
					'html' => __( 'HTML', 'avator-element' ),
					'plain' => __( 'Plain', 'avator-element' ),
				],
			]
		);
	...
	public function run( $record, $ajax_handler ) {
		...
		$fields = [
			...
			/* translators: %s: Site title. */
			'email_subject' => sprintf( __( 'New message from "%s"', 'avator-element' ), get_bloginfo( 'name' ) ),
		 ...
		 */
		$headers = apply_filters( 'avator_element/forms/wp_mail_headers', $headers );
		 ...
		 */
		$fields['email_content'] = apply_filters( 'avator_element/forms/wp_mail_message', $fields['email_content'] );
		 ...
		 */
		do_action( 'avator_element/forms/mail_sent', $settings, $record );
