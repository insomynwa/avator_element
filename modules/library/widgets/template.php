<?php
namespace AvatorElement\Modules\Library\Widgets;
...
class Template extends Base_Widget {
	...
	public function get_title() {
		return __( 'Template', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_template',
			[
				'label' => __( 'Template', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			'template_id',
			[
				'label' => __( 'Choose Template', 'avator-element' ),
