...
namespace AvatorElement\Modules\Gallery\Widgets;
...
class Gallery extends Base_Widget {
	...
	public function get_title() {
		return __( 'Gallery', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section( 'settings', [ 'label' => __( 'Settings', 'avator-element' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'default' => 'single',
				'options' => [
					'single' => __( 'Single', 'avator-element' ),
					'multiple' => __( 'Multiple', 'avator-element' ),
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'New Gallery', 'avator-element' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Galleries', 'avator-element' ),
				'fields' => $repeater->get_controls(),
				'title_field' => '{{{ gallery_title }}}',
				'default' => [
					[
						'gallery_title' => __( 'New Gallery', 'avator-element' ),
					],
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'default' => 'grid',
				'options' => [
					'grid' => __( 'Grid', 'avator-element' ),
					'justified' => __( 'Justified', 'avator-element' ),
					'masonry' => __( 'Masonry', 'avator-element' ),
				],
		...
		$this->add_responsive_control(
			'ideal_row_height',
			[
				'label' => __( 'Row Height', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::SELECT,
				'label' => __( 'Aspect Ratio', 'avator-element' ),
				'default' => '3:2',
				'options' => [
					'1:1' => '1:1',
					'3:2' => '3:2',
		...
		$this->add_control(
			...
			[
				...
				'label' => __( '"All" Filter', 'avator-element' ),
				'default' => 'yes',
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::TEXT,
				'label' => __( '"All" Filter Label', 'avator-element' ),
				'default' => __( 'All', 'avator-element' ),
				'condition' => [
		...
		$this->start_controls_section( 'overlay', [ 'label' => __( 'Overlay', 'avator-element' ) ] );
