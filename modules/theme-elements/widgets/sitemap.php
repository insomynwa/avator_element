...
use AvatorElement\Modules\QueryControl\Controls\Group_Control_Query;
use AvatorElement\Modules\QueryControl\Classes\Elementor_Post_Query;
...
class Sitemap extends Base {
	...
	public function get_title() {
		return __( 'Sitemap', 'avator-element' );
	}
	...
	private function register_sitemap_tab() {
		$this->start_controls_section(
			'sitemap_section',
			[
				'label' => __( 'Sitemap', 'avator-element' ),
	...
	private function register_additional_settings_section() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Protected Posts', 'avator-element' ),
	...
	private function register_layout_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Add nofollow', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
			]
		);
	}
	...
	private function register_post_type_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'post_type',
				'options' => [
					'post_type' => __( 'Post Type', 'avator-element' ),
					'taxonomy' => __( 'Taxonomy', 'avator-element' ),
				],
			]
		);
		...
		$repeater->add_control(
			'sitemap_hide_empty',
			[
				'label' => __( 'Hide Empty', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => [
					'sitemap_type_selector' => 'taxonomy',
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Hierarchical View', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
			]
		);
		...
		$repeater->add_control(
			'sitemap_depth',
			[
				'label' => __( 'Depth', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
				'options' => [
					'0' => __( 'All', 'avator-element' ),
					'1' => 1,
					'2' => 2,
					'3' => 3,
					'4' => 4,
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'sitemap_type_selector' => 'post_type',
						'sitemap_title' => __( 'Pages', 'avator-element' ),
						'sitemap_source_post_type' => 'page',
					],
					[
						'sitemap_type_selector' => 'taxonomy',
						'sitemap_title' => __( 'Categories', 'avator-element' ),
	...
	private function register_style_tab() {
		...
		$this->add_control(
			'sitemap_list_style',
			[
				'label' => __( 'List Item', 'avator-element' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Bullet', 'avator-element' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'disc' => [
						'title' => __( 'Disc', 'avator-element' ),
						'icon' => 'eicon-circle',
					],
					'circle' => [
						'title' => __( 'Circle', 'avator-element' ),
						'icon' => 'eicon-circle-o',
					],
					'square' => [
						'title' => __( 'Square', 'avator-element' ),
						'icon' => 'eicon-square',
					],
					'none' => [
	...
	private function render_sitemap_item( $sitemap_item, $title_tag, $query_args ) {
		...
		if ( empty( $items_html ) ) {
			$html .= sprintf( '<span %s>%s</span>', $this->get_render_attribute_string( 'list' . $item_type ), __( 'None', 'avator-element' ) );
		} else {
