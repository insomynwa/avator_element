...
class Post_Navigation extends Base {
	...
	public function get_title() {
		return __( 'Post Navigation', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Post Navigation', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			'prev_label',
			[
				'label' => __( 'Previous Label', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Previous', 'avator-element' ),
				'condition' => [
					'show_label' => 'yes',
				],
			]
		...
		$this->add_control(
			'next_label',
			[
				'label' => __( 'Next Label', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Next', 'avator-element' ),
				'condition' => [
					'show_label' => 'yes',
				],
			]
		...
		$this->add_control(
			'arrow',
			[
				'label' => __( 'Arrows Type', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fa fa-angle-left' => __( 'Angle', 'avator-element' ),
					'fa fa-angle-double-left' => __( 'Double Angle', 'avator-element' ),
					'fa fa-chevron-left' => __( 'Chevron', 'avator-element' ),
					'fa fa-chevron-circle-left' => __( 'Chevron Circle', 'avator-element' ),
					'fa fa-caret-left' => __( 'Caret', 'avator-element' ),
					'fa fa-arrow-left' => __( 'Arrow', 'avator-element' ),
					'fa fa-long-arrow-left' => __( 'Long Arrow', 'avator-element' ),
					'fa fa-arrow-circle-left' => __( 'Arrow Circle', 'avator-element' ),
					'fa fa-arrow-circle-o-left' => __( 'Arrow Circle Negative', 'avator-element' ),
				],
		...
		$this->add_control(
			'show_title',
			[
				'label' => __( 'Post Title', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'avator-element' ),
				'label_off' => __( 'Hide', 'avator-element' ),
				'default' => 'yes',
		...
		$this->add_control(
			'show_borders',
			[
				'label' => __( 'Borders', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'avator-element' ),
				'label_off' => __( 'Hide', 'avator-element' ),
				'default' => 'yes',
		...
		$this->add_control(
			'in_same_term',
			[
				'label' => __( 'In same Term', 'avator-element' ),
				'type' => Controls_Manager::SELECT2,
				'options' => $post_type_options,
				'default' => '',
				'multiple' => true,
				'label_block' => true,
				'description' => __( 'Indicates whether next post must be within the same taxonomy term as the current post, this lets you set a taxonomy per each post type', 'avator-element' ),
			]
		);
		...
		foreach ( $post_type_options as $post_type => $post_type_label ) {
			$this->add_control(
				$post_type . '_taxonomy',
				[
					'label' => $post_type_label . ' ' . __( 'Taxonomy', 'avator-element' ),
					'type' => Controls_Manager::SELECT,
	...
	protected function render() {
		...
		if ( 'yes' === $settings['show_arrow'] ) {
			...
			$prev_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-prev"><i class="' . $prev_icon_class . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__( 'Prev', 'avator-element' ) . '</span></span>';
			$next_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-next"><i class="' . $next_icon_class . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__( 'Next', 'avator-element' ) . '</span></span>';
		}
