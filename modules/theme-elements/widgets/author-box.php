...
class Author_Box extends Base {
	...
	public function get_title() {
		return __( 'Author Box', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_author_info',
			[
				'label' => __( 'Author Info', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'current',
				'options' => [
					'current' => __( 'Current Author', 'avator-element' ),
		...
		$this->add_control(
			'show_avatar',
			[
				'label' => __( 'Profile Picture', 'avator-element' ),
		...
		$this->add_control(
			'show_name',
			[
				'label' => __( 'Display Name', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'website' => __( 'Website', 'avator-element' ),
					'posts_archive' => __( 'Posts Archive', 'avator-element' ),
				],
				'condition' => [
					'source!' => 'custom',
				],
				'description' => __( 'Link for the Author Name and Image', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			'show_biography',
			[
				'label' => __( 'Biography', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'show_link',
			[
				'label' => __( 'Archive Button', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'link_text',
			[
				'label' => __( 'Archive Text', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'All Posts', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Vertical Align', 'avator-element' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'top' => [
		...
		$this->add_responsive_control(
			'image_size',
			[
				'label' => __( 'Image Size', 'avator-element' ),
