...
class Search_Form extends Base {
	...
	public function get_title() {
		return __( 'Search Form', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'search_content',
			[
				'label' => __( 'Search Form', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'minimal' => __( 'Minimal', 'avator-element' ),
					'full_screen' => __( 'Full Screen', 'avator-element' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'default' => __( 'Search', 'avator-element' ) . '...',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'search' => [
						'title' => __( 'Search', 'avator-element' ),
						'icon' => 'eicon-search',
					],
					'arrow' => [
						'title' => __( 'Arrow', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Toggle', 'avator-element' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'skin' => 'full_screen',
		...
		$this->add_control(
			'button_border_width',
			[
				'label' => __( 'Border Size', 'avator-element' ),
	...
	protected function render() {
		...
		<form class="elementor-search-form" role="search" action="<?php echo home_url(); ?>" method="get">
			<?php do_action( 'avator_element/search_form/before_input', $this ); ?> 
			<?php if ( 'full_screen' === $settings['skin'] ) : ?>
			<div class="elementor-search-form__toggle">
				<?php if ( ! $migration_allowed || ! Icons_Manager::render_icon( $icon, [ 'aria-hidden' => 'true' ] ) ) { ?>
					<i class="fa fa-search" aria-hidden="true"></i>
				<?php } ?>
				<span class="elementor-screen-only"><?php esc_html_e( 'Search', 'avator-element' ); ?></span>
			</div>
			<?php endif; ?>
			<div class="elementor-search-form__container">
				...
				<?php do_action( 'avator_element/search_form/after_input', $this ); ?>
				<?php if ( 'classic' === $settings['skin'] ) : ?>
					<button class="elementor-search-form__submit" type="submit" title="<?php esc_attr_e( 'Search', 'avator-element' ); ?>" aria-label="<?php esc_attr_e( 'Search', 'avator-element' ); ?>">
				...
				<div class="dialog-lightbox-close-button dialog-close-button">
					...
					<span class="elementor-screen-only"><?php esc_html_e( 'Close', 'avator-element' ); ?></span>
				</div>
				<?php endif ?>
			</div>
		</form>
	...
	protected function _content_template() {
		...
		<form class="elementor-search-form" action="" role="search">
			...
			<div class="elementor-search-form__container">
				...
				<input type="search"
					   name="s"
					   title="<?php esc_attr_e( 'Search', 'avator-element' ); ?>"
					   class="elementor-search-form__input"
					   placeholder="{{ settings.placeholder }}">
				...
				<# if ( 'classic' === settings.skin ) { #>
					<button class="elementor-search-form__submit" type="submit">
						<# if ( 'icon' === settings.button_type ) { #>
							...
							<span class="elementor-screen-only"><?php esc_html_e( 'Submit', 'avator-element' ); ?></span>
