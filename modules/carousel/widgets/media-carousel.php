<?php
namespace AvatorElement\Modules\Carousel\Widgets;
...
class Media_Carousel extends Base {
	...
	public function get_title() {
		return __( 'Media Carousel', 'avator-element' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Lightbox', 'avator-element' ),
		...
		$this->add_control(
			'lightbox_ui_color',
			[
				'label' => __( 'UI Color', 'avator-element' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'UI Hover Color', 'avator-element' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Video Width', 'avator-element' ),
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'file' => __( 'Media File', 'avator-element' ),
					'custom' => __( 'Custom URL', 'avator-element' ),
				],
				'condition' => [
					'type' => 'image',
				],
		...
		$repeater->add_control(
			'video',
			[
				'label' => __( 'Video Link', 'avator-element' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'Enter your video link', 'avator-element' ),
				'description' => __( 'YouTube or Vimeo link', 'avator-element' ),
				'show_external' => false,
				'condition' => [
					'type' => 'video',
				],
		...
		<div <?php echo $this->get_render_attribute_string( $element_key . '-image' ); ?>>
			<?php if ( 'video' === $slide['type'] && $settings['video_play_icon'] ) : ?>
				<div class="elementor-custom-embed-play">
					...
					<span class="elementor-screen-only"><?php _e( 'Play', 'avator-element' ); ?></span>
				</div>
			<?php endif; ?>
		</div>
	...
	private function add_injections() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'carousel',
				'options' => [
					'carousel' => __( 'Carousel', 'avator-element' ),
					'slideshow' => __( 'Slideshow', 'avator-element' ),
					'coverflow' => __( 'Coverflow', 'avator-element' ),
				],
		...
		$this->add_control(
			'image_fit',
			[
				'label' => __( 'Image Fit', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'Cover', 'avator-element' ),
					'contain' => __( 'Contain', 'avator-element' ),
					'auto' => __( 'Auto', 'avator-element' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'play_icon_title',
			[
				'label' => __( 'Play Icon', 'avator-element' ),
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'text_shadow_type' => [
						'label' => _x( 'Shadow', 'Text Shadow Control', 'avator-element' ),
					],
				],
			]
		);
		...
		$this->add_control(
			'caption',
			[
				'label' => __( 'Caption', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'title',
				'options' => [
		...
		$this->add_control(
			'thumbs_title',
			[
				'label' => __( 'Thumbnails', 'avator-element' ),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin' => 'slideshow',
				],
		...
		$this->add_control(
			'centered_slides',
			[
				'label' => __( 'Centered Slides', 'avator-element' ),
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SELECT,
				'label' => __( 'Slides Per View', 'avator-element' ),
				'options' => [ '' => __( 'Default', 'avator-element' ) ] + $slides_per_view,
				'condition' => [
					'skin' => 'slideshow',
				],
				'frontend_available' => true,
