...
class Testimonial_Carousel extends Base {
	...
	public function get_title() {
		return __( 'Testimonial Carousel', 'avator-element' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'bubble' => __( 'Bubble', 'avator-element' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'image_inline' => __( 'Image Inline', 'avator-element' ),
					'image_stacked' => __( 'Image Stacked', 'avator-element' ),
					'image_above' => __( 'Image Above', 'avator-element' ),
					'image_left' => __( 'Image Left', 'avator-element' ),
					'image_right' => __( 'Image Right', 'avator-element' ),
				],
		...
		$this->start_controls_section(
			'section_skin_style',
			[
				'label' => __( 'Bubble', 'avator-element' ),
	...
	protected function get_repeater_defaults() {
		...
		return [
			[
				'content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'avator-element' ),
				'name' => __( 'John Doe', 'avator-element' ),
				'title' => __( 'CEO', 'avator-element' ),
				'image' => [
