...
class Reviews extends Base {
	...
	public function get_title() {
		return __( 'Reviews', 'avator-element' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'show_separator',
			[
				'label' => __( 'Separator', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Review', 'avator-element' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => __( 'Official', 'avator-element' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Rating', 'avator-element' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'unmarked_star_style',
			[
				'label' => __( 'Unmarked Style', 'avator-element' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'solid' => [
						'title' => __( 'Solid', 'avator-element' ),
						'icon' => 'eicon-star',
					],
					'outline' => [
						'title' => __( 'Outline', 'avator-element' ),
						'icon' => 'eicon-star-o',
					],
				],
				'default' => 'solid',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Unmarked Color', 'avator-element' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	private function print_icon( $slide, $element_key ) {
		...
		$icon .= '<span class="elementor-screen-only">' . esc_html__( 'Read More', 'avator-element' ) . '</span>';
