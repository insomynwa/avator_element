...
abstract class Posts_Base extends Base_Widget {
	...
	public function register_pagination_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'numbers' => __( 'Numbers', 'avator-element' ),
					'prev_next' => __( 'Previous/Next', 'avator-element' ),
					'numbers_and_prev_next' => __( 'Numbers', 'avator-element' ) . ' + ' . __( 'Previous/Next', 'avator-element' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Page Limit', 'avator-element' ),
				'default' => '5',
				'condition' => [
					'pagination_type!' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Shorten', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( '&laquo; Previous', 'avator-element' ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Next &raquo;', 'avator-element' ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
