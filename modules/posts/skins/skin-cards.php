...
class Skin_Cards extends Skin_Base {
	...
	public function get_title() {
		return __( 'Cards', 'avator-element' );
	}
	...
	protected function register_thumbnail_controls() {
		...
		$this->update_control(
			'thumbnail',
			[
				'label' => __( 'Show Image', 'avator-element' ),
				'options' => [
					'top' => __( 'Yes', 'avator-element' ),
					'none' => __( 'No', 'avator-element' ),
				],
	...
	public function register_badge_controls() {
		...
		$this->add_control(
			'badge_taxonomy',
			[
				'label' => __( 'Badge Taxonomy', 'avator-element' ),
	...
	public function register_design_card_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Box Shadow', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'hover_effect',
			[
				'label' => __( 'Hover Effect', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					'none' => __( 'None', 'avator-element' ),
					'gradient' => __( 'Gradient', 'avator-element' ),
					//'zoom-in' => __( 'Zoom In', 'avator-element' ),
					//'zoom-out' => __( 'Zoom Out', 'avator-element' ),
				],
				'default' => 'gradient',
				'separator' => 'before',
		...
		$this->add_control(
			'meta_border_color',
			[
				'label' => __( 'Meta Border Color', 'avator-element' ),
				'type' => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
