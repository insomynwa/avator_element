<?php
namespace AvatorElement\Modules\Posts\Skins;
...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	protected function register_thumbnail_controls() {
		$this->add_control(
			'thumbnail',
			[
				'label' => __( 'Image Position', 'avator-element' ),
		...
		$this->add_responsive_control(
			'item_ratio',
			[
				'label' => __( 'Image Ratio', 'avator-element' ),
		...
		$this->add_responsive_control(
			'image_width',
			[
				'label' => __( 'Image Width', 'avator-element' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'%' => [
						'min' => 10,
	...
	protected function register_excerpt_controls() {
		$this->add_control(
			'show_excerpt',
			[
				'label' => __( 'Excerpt', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'avator-element' ),
				'label_off' => __( 'Hide', 'avator-element' ),
				'default' => 'yes',
		...
		$this->add_control(
			'excerpt_length',
			[
				'label' => __( 'Excerpt Length', 'avator-element' ),
				'type' => Controls_Manager::NUMBER,
	...
	protected function register_read_more_controls() {
		$this->add_control(
			'show_read_more',
			[
				'label' => __( 'Read More', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'avator-element' ),
				'label_off' => __( 'Hide', 'avator-element' ),
				'default' => 'yes',
		...
		$this->add_control(
			'read_more_text',
			[
				'label' => __( 'Read More Text', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More »', 'avator-element' ),
				'condition' => [
	...
	protected function register_meta_data_controls() {
		...
		$this->add_control(
			'meta_separator',
			[
				'label' => __( 'Separator Between', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => '///',
				'selectors' => [
	...
	protected function register_design_content_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Separator Color', 'avator-element' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render_loop_footer() {
		...
		if ( $has_numbers ) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">' . __( 'Page', 'avator-element' ) . '</span>',
			];
		...
		?>
		<nav class="elementor-pagination" role="navigation" aria-label="<?php esc_attr_e( 'Pagination', 'avator-element' ); ?>">
