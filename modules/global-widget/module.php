<?php
namespace AvatorElement\Modules\GlobalWidget;
...
class Module extends Module_Base {
	...
	public function add_templates_localize_data( $settings ) {
		...
		$settings = array_replace_recursive( $settings, [
			...
			'i18n' => [
				'unlink' => __( 'Unlink', 'avator-element' ),
				'cancel' => __( 'Cancel', 'avator-element' ),
				'unlink_widget' => __( 'Unlink Widget', 'avator-element' ),
				'global' => __( 'Global', 'avator-element' ),
				'dialog_confirm_unlink' => __( 'This will make the widget stop being global. It\'ll be reverted into being just a regular widget.', 'avator-element' ),
				'global_widget_save_title' => __( 'Save your widget as a global widget', 'avator-element' ),
				'global_widget_save_description' => __( 'You\'ll be able to add this global widget to multiple areas on your site, and edit it from one single place.', 'avator-element' ),
				'linked_to_global' => __( 'Linked to Global', 'avator-element' ),
			],
		] );
	...
	private function add_hooks() {
		...
		add_filter( 'avator_element/editor/localize_settings', [ $this, 'add_templates_localize_data' ] );
