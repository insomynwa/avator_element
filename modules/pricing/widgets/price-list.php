...
class Price_List extends Base_Widget {
	...
	public function get_title() {
		return __( 'Price List', 'avator-element' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'price_list',
			[
				'label' => __( 'List Items', 'avator-element' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => __( 'First item on the list', 'avator-element' ),
						'item_description' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'avator-element' ),
						'price' => '$20',
						'link' => [ 'url' => '#' ],
					],
					[
						'title' => __( 'Second item on the list', 'avator-element' ),
						'item_description' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'avator-element' ),
						'price' => '$9',
						'link' => [ 'url' => '#' ],
					],
					[
						'title' => __( 'Third item on the list', 'avator-element' ),
						'item_description' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'avator-element' ),
						'price' => '$32',
						'link' => [ 'url' => '#' ],
					],
		...
		$this->add_control(
			'heading__title',
			[
				'label' => __( 'Title & Price', 'avator-element' ),
