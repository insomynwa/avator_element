<?php
namespace AvatorElement\Modules\ShareButtons\Widgets;
...
use AvatorElement\Modules\ShareButtons\Module;
...
class Share_Buttons extends Base_Widget {
	...
	public function get_title() {
		return __( 'Share Buttons', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Share Buttons', 'avator-element' ),
			]
		);
		...
		$repeater->add_control(
			'button',
			[
				'label' => __( 'Network', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				...
				'title_field' => '<i class="{{ avatorElement.modules.shareButtons.getNetworkClass( button ) }}" aria-hidden="true"></i> {{{ avatorElement.modules.shareButtons.getNetworkTitle( obj ) }}}',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'gradient' => __( 'Gradient', 'avator-element' ),
					'minimal' => __( 'Minimal', 'avator-element' ),
					'framed' => __( 'Framed', 'avator-element' ),
					'boxed' => __( 'Boxed Icon', 'avator-element' ),
					'flat' => __( 'Flat', 'avator-element' ),
				],
				'default' => 'gradient',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'rounded' => __( 'Rounded', 'avator-element' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Justify', 'avator-element' ),
		...
		$this->add_responsive_control(
			'button_size',
			[
				'label' => __( 'Button Size', 'avator-element' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0.5,
		...
		$this->add_responsive_control(
			'button_height',
			[
				'label' => __( 'Button Height', 'avator-element' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'em' => [
						'min' => 1,
					...
					<div class="<?php echo esc_attr( $button_classes . $social_network_class ); ?>">
						<?php if ( 'icon' === $settings['view'] || 'icon-text' === $settings['view'] ) : ?>
							<span class="elementor-share-btn__icon">
								...
								<span class="elementor-screen-only"><?php echo sprintf( __( 'Share on %s', 'avator-element' ), $network_name ); ?></span>
							</span>
						<?php endif; ?>
						<?php if ( $show_text ) : ?>
	...
	protected function _content_template() {
		?>
		<#
			var shareButtonsEditorModule = avatorElement.modules.shareButtons,
