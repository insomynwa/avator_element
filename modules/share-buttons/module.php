<?php
namespace AvatorElement\Modules\ShareButtons;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'avator_element/frontend/localize_settings', [ $this, 'add_localize_data' ] );

		add_filter( 'avator_element/editor/localize_settings', [ $this, 'add_localize_data' ] );
