<?php
namespace AvatorElement\Modules\AnimatedHeadline\Widgets;
...
class Animated_Headline extends Widget_Base {
	...
	public function get_title() {
		return __( 'Animated Headline', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'text_elements',
			[
				'label' => __( 'Headline', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'highlight',
				'options' => [
					'highlight' => __( 'Highlighted', 'avator-element' ),
					'rotate' => __( 'Rotating', 'avator-element' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'circle',
				'options' => [
					'circle' => _x( 'Circle', 'Shapes', 'avator-element' ),
					'curly' => _x( 'Curly', 'Shapes', 'avator-element' ),
					'underline' => _x( 'Underline', 'Shapes', 'avator-element' ),
					'double' => _x( 'Double', 'Shapes', 'avator-element' ),
					'double_underline' => _x( 'Double Underline', 'Shapes', 'avator-element' ),
					'underline_zigzag' => _x( 'Underline Zigzag', 'Shapes', 'avator-element' ),
					'diagonal' => _x( 'Diagonal', 'Shapes', 'avator-element' ),
					'strikethrough' => _x( 'Strikethrough', 'Shapes', 'avator-element' ),
					'x' => 'X',
				],
				'render_type' => 'template',
				'condition' => [
		...
		$this->add_control(
			'before_text',
			[
				'label' => __( 'Before Text', 'avator-element' ),
				...
				'default' => __( 'This page is', 'avator-element' ),
				'placeholder' => __( 'Enter your headline', 'avator-element' ),
				'label_block' => true,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'highlighted_text',
			[
				'label' => __( 'Highlighted Text', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Amazing', 'avator-element' ),
				'label_block' => true,
				'condition' => [
					'headline_style' => 'highlight',
				],
		...
		$this->add_control(
			'rotating_text',
			[
				'label' => __( 'Rotating Text', 'avator-element' ),
				'type' => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'Enter each word in a separate line', 'avator-element' ),
				'separator' => 'none',
				'default' => "Better\nBigger\nFaster",
				'condition' => [
					'headline_style' => 'rotate',
		...
		$this->add_control(
			'after_text',
			[
				'label' => __( 'After Text', 'avator-element' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
					'categories' => [
		...
		$this->add_control(
			'above_content',
			[
				'label' => __( 'Bring to Front', 'avator-element' ),
		...
		$this->add_control(
			'rounded_edges',
			[
				'label' => __( 'Rounded Edges', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Animated Text', 'avator-element' ),
				'separator' => 'before',
			]
		);
