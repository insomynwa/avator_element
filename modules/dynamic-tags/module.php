<?php
namespace AvatorElement\Modules\DynamicTags;

use Elementor\Modules\DynamicTags\Module as TagsModule;
use AvatorElement\Modules\DynamicTags\ACF;
use AvatorElement\Modules\DynamicTags\Toolset;
use AvatorElement\Modules\DynamicTags\Pods;
...
class Module extends TagsModule {
	...
	public function get_groups() {
		return [
			self::POST_GROUP => [
				'title' => __( 'Post', 'avator-element' ),
			],
			self::ARCHIVE_GROUP => [
				'title' => __( 'Archive', 'avator-element' ),
			],
			self::SITE_GROUP => [
				'title' => __( 'Site', 'avator-element' ),
			],
			self::MEDIA_GROUP => [
				'title' => __( 'Media', 'avator-element' ),
			],
			self::ACTION_GROUP => [
				'title' => __( 'Actions', 'avator-element' ),
			],
			self::AUTHOR_GROUP => [
				'title' => __( 'Author', 'avator-element' ),
			],
			self::COMMENTS_GROUP => [
				'title' => __( 'Comments', 'avator-element' ),
			],
		];
	}
}
