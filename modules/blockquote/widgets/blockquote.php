<?php
namespace AvatorElement\Modules\Blockquote\Widgets;
...
class Blockquote extends Widget_Base {
	...
	public function get_title() {
		return __( 'Blockquote', 'avator-element' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Blockquote', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'border' => __( 'Border', 'avator-element' ),
					'quotation' => __( 'Quotation', 'avator-element' ),
					'boxed' => __( 'Boxed', 'avator-element' ),
					'clean' => __( 'Clean', 'avator-element' ),
				],
				'default' => 'border',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'avator-element' ) . __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'avator-element' ),
				'placeholder' => __( 'Enter your quote', 'avator-element' ),
				'rows' => 10,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'John Doe', 'avator-element' ),
				'label_block' => false,
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			'tweet_button',
			[
				'label' => __( 'Tweet Button', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Tweet', 'avator-element' ),
				'label_block' => false,
				'condition' => [
					'tweet_button' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'current_page' => __( 'Current Page', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'official' => __( 'Official', 'avator-element' ),
					'custom' => __( 'Custom', 'avator-element' ),
				],
				'default' => 'official',
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Border', 'avator-element' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'blockquote_skin' => 'border',
				],
						...
						<a href="<?php echo esc_attr( $share_link ); ?>" class="elementor-blockquote__tweet-button" target="_blank">
							<?php if ( 'text' !== $tweet_button_view ) : ?>
								...
								<?php if ( 'icon-text' !== $tweet_button_view ) : ?>
									<span class="elementor-screen-only"><?php esc_html_e( 'Tweet', 'avator-element' ); ?></span>
								<?php endif; ?>
							<?php endif; ?>
						...
						<# if ( 'yes' === settings.tweet_button ) { #>
							<a href="#" class="elementor-blockquote__tweet-button">
								<# if ( 'text' !== tweetButtonView ) { #>
									<i class="fa fa-twitter" aria-hidden="true"></i><span class="elementor-screen-only"><?php esc_html_e( 'Tweet', 'avator-element' ); ?></span>
								<# } #>
