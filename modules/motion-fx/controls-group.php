...
namespace AvatorElement\Modules\MotionFX;
...
class Controls_Group extends Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [
			'motion_fx_scrolling' => [
				'label' => __( 'Scrolling Effects', 'avator-element' ),
		...
		$fields['transform_origin_x'] = [
			'label' => __( 'X Anchor Point', 'avator-element' ),
		...
		$fields['transform_origin_y'] = [
			'label' => __( 'Y Anchor Point', 'avator-element' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'center',
			'options' => [
				'top' => [
		...
		$fields['devices'] = [
			'label' => __( 'Apply Effects On', 'avator-element' ),
		...
		$fields['range'] = [
			'label' => __( 'Effects relative to', 'avator-element' ),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'' => __( 'Default', 'avator-element' ),
				'viewport' => __( 'Viewport', 'avator-element' ),
				'page' => __( 'Entire Page', 'avator-element' ),
			],
			'condition' => [
				'motion_fx_scrolling' => 'yes',
			],
		...
		$fields['motion_fx_mouse'] = [
			'label' => __( 'Mouse Effects', 'avator-element' ),
			'type' => Controls_Manager::SWITCHER,
			'label_off' => __( 'Off', 'avator-element' ),
			'label_on' => __( 'On', 'avator-element' ),
			'separator' => 'before',
	...
	private function get_scrolling_effects() {
		return [
			'translateY' => [
				'label' => __( 'Vertical Scroll', 'avator-element' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'avator-element' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => __( 'Up', 'avator-element' ),
							'negative' => __( 'Down', 'avator-element' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'avator-element' ),
					...
					'affectedRange' => [
						'label' => __( 'Viewport', 'avator-element' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'sizes' => [
								'start' => 0,
						...
						'labels' => [
							__( 'Bottom', 'avator-element' ),
							__( 'Top', 'avator-element' ),
						],
						'scales' => 1,
						'handles' => 'range',
					],
			...
			'translateX' => [
				'label' => __( 'Horizontal Scroll', 'avator-element' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'avator-element' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => __( 'To Left', 'avator-element' ),
							'negative' => __( 'To Right', 'avator-element' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'avator-element' ),
			...
			'opacity' => [
				'label' => __( 'Transparency', 'avator-element' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'avator-element' ),
						'type' => Controls_Manager::SELECT,
			...
			'rotateZ' => [
				'label' => __( 'Rotate', 'avator-element' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'avator-element' ),
						'type' => Controls_Manager::SELECT,
	...
	private function get_mouse_effects() {
		return [
			'mouseTrack' => [
				'label' => __( 'Mouse Track', 'avator-element' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'avator-element' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => __( 'Opposite', 'avator-element' ),
							'negative' => __( 'Direct', 'avator-element' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'avator-element' ),
			...
			'tilt' => [
				'label' => __( '3D Tilt', 'avator-element' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'avator-element' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => __( 'Direct', 'avator-element' ),
							'negative' => __( 'Opposite', 'avator-element' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'avator-element' ),
