<?php
namespace AvatorElement\Modules\NavMenu\Widgets;
...
class Nav_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'Nav Menu', 'avator-element' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label' => __( 'Menu', 'avator-element' ),
					'type' => Controls_Manager::SELECT,
					'options' => $menus,
					'default' => array_keys( $menus )[0],
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'avator-element' ), admin_url( 'nav-menus.php' ) ),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __( 'There are no menus in your site.', 'avator-element' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'avator-element' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'options' => [
					'horizontal' => __( 'Horizontal', 'avator-element' ),
					'vertical' => __( 'Vertical', 'avator-element' ),
					'dropdown' => __( 'Dropdown', 'avator-element' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Stretch', 'avator-element' ),
		...
		$this->add_control(
			'pointer',
			[
				'label' => __( 'Pointer', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'underline',
				'options' => [
					'none' => __( 'None', 'avator-element' ),
					'underline' => __( 'Underline', 'avator-element' ),
					'overline' => __( 'Overline', 'avator-element' ),
					'double-line' => __( 'Double Line', 'avator-element' ),
					'framed' => __( 'Framed', 'avator-element' ),
					'background' => __( 'Background', 'avator-element' ),
		...
		$this->add_control(
			'indicator',
			[
				'label' => __( 'Submenu Indicator', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'classic',
				'options' => [
					'none' => __( 'None', 'avator-element' ),
					'classic' => __( 'Classic', 'avator-element' ),
					'chevron' => __( 'Chevron', 'avator-element' ),
					'angle' => __( 'Angle', 'avator-element' ),
					'plus' => __( 'Plus', 'avator-element' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Mobile Dropdown', 'avator-element' ),
		...
		$this->add_control(
			'dropdown',
			[
				'label' => __( 'Breakpoint', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'tablet',
				'options' => [
					/* translators: %d: Breakpoint number. */
					'mobile' => sprintf( __( 'Mobile (< %dpx)', 'avator-element' ), $breakpoints['md'] ),
					/* translators: %d: Breakpoint number. */
					'tablet' => sprintf( __( 'Tablet (< %dpx)', 'avator-element' ), $breakpoints['lg'] ),
					'none' => __( 'None', 'avator-element' ),
				],
		...
		$this->add_control(
			'full_width',
			[
				'label' => __( 'Full Width', 'avator-element' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'Stretch the dropdown of the menu to full width.', 'avator-element' ),
		...
		$this->add_control(
			'toggle',
			[
				'label' => __( 'Toggle Button', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'burger',
				'options' => [
					'' => __( 'None', 'avator-element' ),
					'burger' => __( 'Hamburger', 'avator-element' ),
				],
		...
		$this->add_control(
			'toggle_align',
			[
				'label' => __( 'Toggle Align', 'avator-element' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => [
					'left' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'avator-element' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Pointer Color', 'avator-element' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_4,
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Active', 'avator-element' ),
			]
		);
		...
		$this->add_control(
			'pointer_width',
			[
				'label' => __( 'Pointer Width', 'avator-element' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Horizontal Padding', 'avator-element' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Vertical Padding', 'avator-element' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Dropdown', 'avator-element' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'raw' => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'avator-element' ),
				'type' => Controls_Manager::RAW_HTML,
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?>>
			...
			<span class="elementor-screen-only"><?php _e( 'Menu', 'avator-element' ); ?></span>
		</div>
