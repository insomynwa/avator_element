<?php
namespace AvatorElement\Modules\Sticky;
...
class Module extends Module_Base {
	...
	public function register_controls( Element_Base $element ) {
		$element->add_control(
			'sticky',
			[
				'label' => __( 'Sticky', 'avator-element' ),
		...
		$element->add_control(
			'sticky_on',
			[
				'label' => __( 'Sticky On', 'avator-element' ),
		...
		$element->add_control(
			...
			[
				'label' => __( 'Effects Offset', 'avator-element' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 0,
				'min' => 0,
				'max' => 1000,
		...
		if ( $element instanceof Widget_Base ) {
			$element->add_control(
				'sticky_parent',
				[
					'label' => __( 'Stay In Column', 'avator-element' ),
