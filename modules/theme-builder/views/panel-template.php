...
<script type="text/template" id="tmpl-elementor-theme-builder-conditions-view">
	<div class="elementor-template-library-blank-icon">
		<img src="<?php echo AVATOR_ELEMENT_MODULES_URL; ?>theme-builder/assets/images/conditions-tab.svg">
	</div>
	<div class="elementor-template-library-blank-title">{{{ avatorElement.translate( 'conditions_title' ) }}}</div>
	<div class="elementor-template-library-blank-message">{{{ avatorElement.translate( 'conditions_description' ) }}}</div>
...
<script type="text/template" id="tmpl-elementor-theme-builder-conditions-repeater-row">
	...
	<div class="elementor-repeater-row-tool elementor-repeater-tool-remove">
		...
		<span class="elementor-screen-only"><?php esc_html_e( 'Remove this item', 'avator-element' ); ?></span>
	</div>
</script>

<script type="text/template" id="tmpl-elementor-theme-builder-button-preview">
	<i class="eicon-eye tooltip-target" aria-hidden="true"  data-tooltip="<?php esc_attr_e( 'Preview Changes', 'avator-element' ); ?>"></i>
	<span class="elementor-screen-only">
		<?php esc_attr_e( 'Preview Changes', 'avator-element' ); ?>
	</span>
	<div class="elementor-panel-footer-sub-menu-wrapper">
		<div class="elementor-panel-footer-sub-menu">
			<div id="elementor-panel-footer-theme-builder-button-preview-settings" class="elementor-panel-footer-sub-menu-item">
				...
				<span class="elementor-title"><?php esc_html_e( 'Settings', 'avator-element' ); ?></span>
			</div>
			<div id="elementor-panel-footer-theme-builder-button-open-preview" class="elementor-panel-footer-sub-menu-item">
				...
				<span class="elementor-title"><?php esc_html_e( 'Preview', 'avator-element' ); ?></span>
			</div>
		</div>
	</div>
</script>
