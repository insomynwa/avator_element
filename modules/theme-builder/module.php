<?php
namespace AvatorElement\Modules\ThemeBuilder;
...
use AvatorElement\Modules\ThemeBuilder\Classes;
use AvatorElement\Modules\ThemeBuilder\Documents\Single;
use AvatorElement\Modules\ThemeBuilder\Documents\Theme_Document;
...
class Module extends Module_Base {
	...
	public function get_widgets() {
		...
		if ( class_exists( '\AvatorElement\Modules\Posts\Widgets\Posts' ) ) {
	...
	public function localize_settings( $settings ) {
		...
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'publish_settings' => __( 'Publish Settings', 'avator-element' ),
				'conditions' => __( 'Conditions', 'avator-element' ),
				'display_conditions' => __( 'Display Conditions', 'avator-element' ),
				'choose' => __( 'Choose', 'avator-element' ),
				'add_condition' => __( 'Add Condition', 'avator-element' ),
				'conditions_title' => sprintf( __( 'Where Do You Want to Display Your %s?', 'avator-element' ), $document->get_post_type_title() ),
				'conditions_description' => sprintf( __( 'Set the conditions that determine where your %s is used throughout your site.', 'avator-element' ), $document->get_post_type_title() ) . '<br>' . __( 'For example, choose \'Entire Site\' to display the template across your site.', 'avator-element' ),
				'conditions_publish_screen_description' => __( 'Apply current template to these pages.', 'avator-element' ),
				'save_and_close' => __( 'Save & Close', 'avator-element' ),
			],
			'theme_builder' => [
	...
	public function print_post_type_field() {
		...
		<div id="elementor-new-template__form__post-type__wrapper" class="elementor-form-field">
			<label for="elementor-new-template__form__post-type" class="elementor-form-field__label">
				<?php echo __( 'Select Post Type', 'avator-element' ); ?>
			</label>
			<div class="elementor-form-field__select__wrapper">
				<select id="elementor-new-template__form__post-type" class="elementor-form-field__select" name="<?php echo Single::REMOTE_CATEGORY_META_KEY; ?>">
					...
					// 404.
					echo sprintf( '<option value="%1$s">%2$s</option>', 'not_found404', __( '404 Page', 'avator-element' ) );
	...
	public function add_finder_items( array $categories ) {
		$categories['general']['items']['theme-builder'] = [
			'title' => __( 'Theme Builder', 'avator-element' ),
			'icon' => 'library-save',
		...
		$categories['create']['items']['theme-template'] = [
			'title' => __( 'Add New Theme Template', 'avator-element' ),
			'icon' => 'plus-circle-o',
	...
	public function admin_menu() {
		add_submenu_page( Source_Local::ADMIN_MENU_SLUG, '', __( 'Theme Builder', 'avator-element' ), 'publish_posts', $this->get_admin_templates_url( true ) );
	}
