...
use AvatorElement\Modules\Posts\Widgets\Posts_Base;
use AvatorElement\Modules\ThemeBuilder\Skins;
use AvatorElement\Modules\QueryControl\Module as Query_Control;
...
class Archive_Posts extends Posts_Base {
	...
	public function get_title() {
		return __( 'Archive Posts', 'avator-element' );
	}
	...
	public function register_advanced_section_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Nothing Found Message', 'avator-element' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'It seems we can\'t find what you\'re looking for.', 'avator-element' ),
				'dynamic' => [
					'active' => true,
				],
			]
