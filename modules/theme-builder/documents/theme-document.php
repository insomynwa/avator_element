...
use AvatorElement\Modules\QueryControl\Module as QueryModule;
...
abstract class Theme_Document extends Library_Document {
	...
	public function get_location_label() {
		...
		if ( ! $supported ) {
			$label .= ' (' . __( 'Unsupported', 'avator-element' ) . ')';
		}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'preview_settings',
			[
				'label' => __( 'Preview Settings', 'avator-element' ),
		...
		$this->add_control(
			'preview_type',
			[
				'label' => __( 'Preview Dynamic Content as', 'avator-element' ),
				'label_block' => true,
		...
		$this->add_control(
			'preview_search_term',
			[
				'label' => __( 'Search Term', 'avator-element' ),
				'export' => false,
				'condition' => [
					'preview_type' => 'search',
				],
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Apply & Preview', 'avator-element' ),
				'label_block' => true,
				'show_label' => false,
				'text' => __( 'Apply & Preview', 'avator-element' ),
				'separator' => 'none',
