...
abstract class Theme_Page_Document extends Theme_Document {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'page_template',
			[
				'label' => __( 'Page Layout', 'avator-element' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Default', 'avator-element' ),
					PageTemplatesModule::TEMPLATE_CANVAS => __( 'Elementor Canvas', 'avator-element' ),
					PageTemplatesModule::TEMPLATE_HEADER_FOOTER => __( 'Elementor Full Width', 'avator-element' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'Default Page Template from your theme', 'avator-element' ),
				'separator' => 'none',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'No header, no footer, just Elementor', 'avator-element' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'This template includes the header, full-width content and footer', 'avator-element' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
