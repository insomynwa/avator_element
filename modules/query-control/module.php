<?php
namespace AvatorElement\Modules\QueryControl;

use Elementor\Controls_Manager;
use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use Elementor\Widget_Base;
use AvatorElement\Base\Module_Base;
use AvatorElement\Modules\QueryControl\Controls\Group_Control_Posts;
...
use AvatorElement\Modules\QueryControl\Classes\Elementor_Related_Query;
use AvatorElement\Modules\QueryControl\Controls\Query;
...
class Module extends Module_Base {
	...
	public static function add_exclude_controls( $widget ) {
		...
		$widget->add_control(
			...
			[
				...
				'default' => '',
				'description' => __( 'Set to Yes to avoid duplicate posts from showing up on the page. This only affects the frontend.', 'avator-element' ),
			]
		);
	...
	public function ajax_posts_filter_autocomplete_deprecated( $data ) {
		...
		switch ( $data['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'avator_element/query_control/get_autocomplete/' . $data['filter_type'], [], $data );
		}
	...
	public function ajax_posts_control_value_titles_deprecated( $request ) {
		...
		switch ( $request['filter_type'] ) {
			...
			case 'author':
				...
				break;
			default:
				$results = apply_filters( 'avator_element/query_control/get_value_titles/' . $request['filter_type'], [], $request );
		}
	...
	/**
	 * @param \AvatorElement\Base\Base_Widget $widget
	 * @param string $name
